...
?>
  ...
  <!============================================================================================================grafik>
    <!-- ChartJS 1.0.1 -->
    <script src="<?php echo base_url('style/admin/plugins/chartjs/Chart.min.js');?>"></script>
    <!-- page script -->
    <script>
      $(function () {
        //--------------
          ...
          datasets: [
            {
              ...
              <?php 
                ...
                $tahun;
                while ($loop<=12) {
                      $result2 = mysqli_query($link, "select sum(jumlah) as jml from payment where month(tgl_bayar)='$loop' and year(tgl_bayar)='$tahun'");
